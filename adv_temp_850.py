...
for i in range(len(file_1.variables['time'])):
    ...
    intervalo_min3 = -1.6
    intervalo_max3 = 1.6
    interval_3 = 0.15              # de quanto em quanto voce quer que varie
    ...
    # Add a title
    plt.title('Adveccao de temperatura (K/s) - '+ str(level) +' hPa',
              fontweight='bold', 
              fontsize=35, 
              loc='left'
              )
    ...
    #--------------------------------------------------------------------------
    # Salva imagem
    plt.savefig(f'adveccao_de_temperatura_{date_formatted}.png', bbox_inches='tight')