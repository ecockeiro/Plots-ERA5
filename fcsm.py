...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  4 21:35:00 2022
...
img = plt.contourf(lons,lats, fcsm, vmin=vmin, vmax=vmax, cmap='jet', levels = levels, extend='both')
#img2 = ax.contour(lons, lats, fcsm, colors='green', linewidths=1)
...
# Add a title
plt.title('Fluxo de calor sensivel médio', fontweight='bold', fontsize=30, loc='left')
plt.title(f'{date_formatted}', fontsize=15, loc='right')


#----------------------------------------------------------------------------------------------------------- 
# Salva imagem
plt.savefig(f'fcsm {date_formatted}.png', bbox_inches='tight')
